    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl p-4 border border-indigo-200 shadow-sm">
          <p className="text-2xl font-black text-indigo-700">{devisCount}</p>
          <p className="text-xs text-slate-500">Devis</p>
        </div>
        <div className="bg-white rounded-xl p-4 border border-purple-200 shadow-sm">
          <p className="text-2xl font-black text-purple-700">{proformaCount}</p>
        ...
        <div className="bg-white rounded-xl p-4 border border-sagard-yellow shadow-sm">
          <p className="text-lg font-black text-slate-800">{fmt(totalAmount)}</p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-100">
                  {['Référence', 'Type', 'Prospect / Client', 'Date', 'Validité', 'Montant', 'Statut', 'Actions'].map(h => (
              ...
              <div className="px-6 py-5 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select value={prospectId} onChange={e => { setProspectId(e.target.value); if (e.target.value) setClientId('') }}
                  ...
                  <div>
                    ...
                    <select value={clientId} onChange={e => { setClientId(e.target.value); if (e.target.value) setProspectId('') }}
                      className="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-sagard-yellow/40 bg-white">
                      <option value="">— Aucun —</option>
